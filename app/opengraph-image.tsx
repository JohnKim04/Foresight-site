...
export const alt = "Foresight: Notice what follows.";
      ...
      >
        ...
        >
          <div style={{ alignItems: "center", display: "flex", fontFamily: "Georgia, serif", fontSize: 42, gap: 16 }}>
            {/* ImageResponse uses a native image element to render the app asset. */}
            <img src={iconSrc} alt="" width={54} height={54} style={{ borderRadius: 12 }} />
            {siteConfig.name}
          </div>
          <div style={{ display: "flex", flexDirection: "column" }}>
            <div style={{ color: "#34503f", fontFamily: "Arial, sans-serif", fontSize: 22, fontWeight: 600, letterSpacing: 2, textTransform: "uppercase" }}>
          ...
          <div style={{ color: "#61685f", display: "flex", fontFamily: "Arial, sans-serif", fontSize: 22, lineHeight: 1.4, maxWidth: 560 }}>
            Write it down. Check in. See what repeats.
          </div>
        </div>
        ...
        >
          <div style={{ color: "#61685f", display: "flex", fontFamily: "Arial, sans-serif", fontSize: 17, fontWeight: 600, justifyContent: "space-between", letterSpacing: 1.3 }}>
            ...
            <span style={{ background: "#dbe4d6", borderRadius: 999, color: "#1c211d", padding: "6px 12px" }}>10 OF 12</span>
          </div>
          ...
          <div style={{ alignItems: "flex-end", background: "#f8f6f0", border: "2px solid #d9d9cf", borderRadius: 18, display: "flex", gap: 14, height: 185, marginTop: 48, padding: 28 }}>
            ...
            <div style={{ background: "#34503f", borderRadius: "5px 5px 0 0", display: "flex", height: 120, width: 18 }} />
            <div style={{ background: "#9aac96", borderRadius: "5px 5px 0 0", display: "flex", height: 94, width: 18 }} />
            <div style={{ background: "#34503f", borderRadius: "5px 5px 0 0", display: "flex", height: 138, width: 18 }} />
          </div>
        </div>
      </div>
    ),
